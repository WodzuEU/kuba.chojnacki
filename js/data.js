/* ============================================================
   ...
   To add a painting:
     ...
     3. Add one entry below, in display order (collections are kept
        sorted by physical size, largest first). Done — grid, legend,
...
const COLLECTIONS = [
  ...
  },
  {
    ...
    works: [
      ...
      { ref: "43", slug: "43-chromatic-deep-green-blue",title: "Chromatic | deep green blue",medium: "acrylic on raw canvas", size: "150 × 100 cm", year: 2026, price: 1500, w: 2588, h: 3450 },
